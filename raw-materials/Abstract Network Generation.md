...
source: "https://sumo.dlr.de/docs/Networks/Abstract_Network_Generation.html"
author:
published:
created: 2026-07-21
description:
tags:
  - "clippings"
---
[netgenerate](https://sumo.dlr.de/docs/netgenerate.html) allows the generation of three types of abstract networks: grid, spider and random.
...
![](https://sumo.dlr.de/docs/images/Netgen_grid1.gif) ![](https://sumo.dlr.de/docs/images/Netgen_grid2.gif)
...
![](https://sumo.dlr.de/docs/images/Netgen_spider1.gif) ![](https://sumo.dlr.de/docs/images/Netgen_spider2.gif)

## Random Networks

The random network generator does just what its name says, it builds random networks. Several settings may be changed:

- **\--rand.iterations** [*\<INT>*](https://sumo.dlr.de/docs/Basics/Notation.html#referenced_data_types):
- **\--rand.bidi-probability** [*\<FLOAT>*](https://sumo.dlr.de/docs/Basics/Notation.html#referenced_data_types): the probability to build a reverse edge
- **\--rand.max-distance** [*\<FLOAT>*](https://sumo.dlr.de/docs/Basics/Notation.html#referenced_data_types): the maximum edge length
- **\--rand.min-distance** [*\<FLOAT>*](https://sumo.dlr.de/docs/Basics/Notation.html#referenced_data_types): the minimum edge length
- **\--rand.min-angle** [*\<FLOAT>*](https://sumo.dlr.de/docs/Basics/Notation.html#referenced_data_types): the minimum angle between two edges
- **\--rand.num-tries** [*\<INT>*](https://sumo.dlr.de/docs/Basics/Notation.html#referenced_data_types):
- **\--rand.connectivity** [*\<FLOAT>*](https://sumo.dlr.de/docs/Basics/Notation.html#referenced_data_types):
- **\--rand.neighbor-dist1** [*\<FLOAT>*](https://sumo.dlr.de/docs/Basics/Notation.html#referenced_data_types):
- **\--rand.neighbor-dist2** [*\<FLOAT>*](https://sumo.dlr.de/docs/Basics/Notation.html#referenced_data_types):
- **\--rand.neighbor-dist3** [*\<FLOAT>*](https://sumo.dlr.de/docs/Basics/Notation.html#referenced_data_types):
- **\--rand.neighbor-dist4** [*\<FLOAT>*](https://sumo.dlr.de/docs/Basics/Notation.html#referenced_data_types):
- **\--rand.neighbor-dist5** [*\<FLOAT>*](https://sumo.dlr.de/docs/Basics/Notation.html#referenced_data_types):
- **\--rand.neighbor-dist6** [*\<FLOAT>*](https://sumo.dlr.de/docs/Basics/Notation.html#referenced_data_types):
...
![](https://sumo.dlr.de/docs/images/Netgen_random1.gif)
...
![](https://sumo.dlr.de/docs/images/Netgen_random_grid1.png) ![](https://sumo.dlr.de/docs/images/Netgen_random_grid2.png)

## Further Options

All abstract network types share some command line options.

- **\--default-junction-type-option** (or **\-j** for short): set the default [type of junctions](https://sumo.dlr.de/docs/Networks/PlainXML.html#node_types). (i.e. 'priority', 'traffic\_light',,,)
...
Further, you can set default values for [streets](https://sumo.dlr.de/docs/netconvert.html#building_defaults) and [traffic lights](https://sumo.dlr.de/docs/netconvert.html#tls_building) by using the same options as in the [netconvert](https://sumo.dlr.de/docs/netconvert.html) -application. Many other netconvert options such as **\--lefthand** are also supported by netgenerate.